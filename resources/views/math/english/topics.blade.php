          ...
          <hr>   
                   ...
                   <div class="card-panel grey">
                         ...
                         <ul class="collection with-header">
                          ...
                          <p class="bottom-three"></p>
                        <h4 style="color: #4a148c; font-family: Comic Sans MS"><i class="prefix material-icons">free_breakfast</i> Also you can access practice arrangements for Bangla Version anytime for free!! <a href="{{route('Math Bangla')}}" >here</a> </h4>
                          <p class="bottom-three"></p>
                         </div>
