...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Examination Center English</title>
        <!--materialize-->
    ...
    <body>
        ...
        <main class="py-4">
         ...
         @if(auth::user()->version=="English" || auth::user()->role=="admin" )

            

                <h1 class=" font-weight-bold" style="color: #00c853 ">Exam Center (English Version)</h1>
