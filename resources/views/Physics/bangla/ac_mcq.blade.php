        ...
        <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col align-self-end">
                       <a class="btn btn-primary" href="{{url('/blog_list')}}">Chapter List</a> 
                    </div>
                </div> <hr>
            <div class="card">
                <div class="card-header text-success"> <h2 >Alternating Current</h2></div>
               <div class="card-body">
                ...
                @foreach($mcqs as $mcq)
                   <div class="card border-success w-100">
                       <div class="card-body">
                           @if($mcq->image!=null)
                       <img src="{{$mcq->image}}" class="img-fluid"  alt="No Photo">
                       @endif
