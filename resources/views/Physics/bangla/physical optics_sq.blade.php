...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header text-success"> <h2 > Physical Optics</h2></div>
               <div class="card-body">
                ...
                @endforeach
                {{$sqs->links()}} 
                <p class="text-danger font-weight-bold">Try to answer on your own.Stuck?? Don't worry. We've got your backHit the answer button and learn the answer.Hit "Try Again" button to repeat.</p> <hr >
