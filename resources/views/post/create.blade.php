            ...
            <div class="card">
               ...
               <div class="card-body">
                <form action="/Posts" method="POST">
                    ...
                    <input class="col-10"type="text" id="title" name="title"><hr>
                    ...
                    <textarea type="text" class="form-control" rows="4" id="body" name="body"></textarea><hr>
                    ...
                    <select name="category" class="col-5"id="category">
                      <option ></option>
                      <option value="Announcement" class="list-group-item list-group-item-primary">Announcement</option>
