...
<div class="container">
    <div class="row justify-content-center">
        ...
        @if (auth::user()->role=="admin" || auth::user()->version=="Bangla") 
            ...
            <div class="card">
                <div class="card-header text-danger" style="font-family: Comic Sans MS"> <h1> Higher Mathematics ACTIVITY </h1>  <small class="text-info font-weight-bold">Bangla Version</small></div>

             <div class="card-body">
                @if(count($posts)>0)
                 @foreach ($posts as $post)
                 <div class="card-panel  cyan darken-4 w-100">
                  <div class="card-title font-weight-bold text-white " style="font-family: Comic Sans MS"><h5>{{$post->title}}</h5></div>
