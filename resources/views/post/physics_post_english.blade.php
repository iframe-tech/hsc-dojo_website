...
<div class="container">
    <div class="row justify-content-center">
        ...
        @if (auth::user()->role=="admin" || auth::user()->version=="English") 
            <div class="card">
                <div class="card-header text-success" style="font-family: Comic Sans MS"> <h1> PHYSICS ACTIVITY </h1>  <small class="text-info font-weight-bold">English Version</small></div>

             <div class="card-body">
                @if(count($posts)>0)
                 @foreach ($posts as $post)
                 <div class="card-panel teal darken-1  w-100">
                 <div class="card-title text-white font-weight-bold" style="font-family: Comic Sans MS"><h5>{{$post->title}}</h5></div>
