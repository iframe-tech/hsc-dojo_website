...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header font-weight-bold" style="font-family: Comic Sans MS;color:#006064"> <h1> pdf LIBRARY </h1>  <small class="text-info font-weight-bold">Bangla Version</small></div>
